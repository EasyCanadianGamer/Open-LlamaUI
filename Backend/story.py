...
try:
    ...
    # print("DEBUG: Loaded JSON data:", character_data, flush=True)
    # Optionally, use the logging module for a more robust solution:
    # logger.debug("Loaded JSON data: %s", character_data)
